...
const sqlFiles = {
  sqlFiles: [
    {
      condition: generator => !generator.reactive && generator.persisted !== DO_NOT_PERSIST,
      path: `${SERVER_MAIN_SRC_DIR}package/`,
      renameTo: moveToJavaEntityPackageSrcDir,
      templates: ['domain/_PersistClass_.java.jhi.jakarta_persistence'],
    },
    {
      condition: generator => !generator.reactive && generator.requiresPersistableImplementation && generator.persisted !== DO_NOT_PERSIST,
      path: `${SERVER_MAIN_SRC_DIR}package/`,
      renameTo: moveToJavaEntityPackageSrcDir,
      templates: ['domain/_PersistClass_.java.jhi.jakarta_lifecycle_events'],
    },
    {
      condition: generator => !generator.reactive && generator.enableHibernateCache && generator.persisted !== DO_NOT_PERSIST,
      path: `${SERVER_MAIN_SRC_DIR}package/`,
      renameTo: moveToJavaEntityPackageSrcDir,
      templates: ['domain/_PersistClass_.java.jhi.hibernate_cache'],
    },
    {
      condition: generator => !generator.reactive && !generator.embedded && generator.containsBagRelationships && generator.persisted !== DO_NOT_PERSIST,
      path: `${SERVER_MAIN_SRC_DIR}package/`,
      renameTo: moveToJavaEntityPackageSrcDir,
      templates: [
    ...
    {
      condition: generator => generator.requiresPersistableImplementation && generator.persisted !== DO_NOT_PERSIST,
      path: `${SERVER_MAIN_SRC_DIR}package/`,
      renameTo: moveToJavaEntityPackageSrcDir,
    ...
    {
      condition: generator => generator.reactive && !generator.embedded && generator.persisted !== DO_NOT_PERSIST,
      path: `${SERVER_MAIN_SRC_DIR}package/`,
      renameTo: moveToJavaEntityPackageSrcDir,
      templates: [
