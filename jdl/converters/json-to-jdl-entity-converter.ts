...
const { ANGULAR_SUFFIX, CLIENT_ROOT_FOLDER, DTO, MICROSERVICE, PAGINATION, PERSISTED, SEARCH, SERVICE } = binaryOptions.Options;
...
function addEntityOptionsToJDL(entity: Entity, entityName: string) {
  ...
  [DTO, PAGINATION, PERSISTED, SERVICE].forEach(option => {
